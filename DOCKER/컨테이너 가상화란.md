...
## config-service
```
아래 그림과 같이 config-service는 rabbitmq에 대한 설정을 하고있다. 현재 rabbitmq의 ip인 172.18.0.2로 직접 변경할 수도 있지만 
운영중에는 해당 ip가 언제든 변경될 수 있다. 따라서 다음과 같이 실행하여 설정할 수 있다.
(같은 네트워크에서 run하는 것이기 때문에 컨테이너 명으로 지정할 수 있다)
$ docker run -d -p 8888:8888 --network ecommerce-network\
          -e "spring.rabbitmq.host=rabbitmq"\
          -e "spring.profiles.active=default"\
          --name config-service rladbsals23/config-service:1.0
```
![image](https://user-images.githubusercontent.com/46228593/136661390-43089e1c-b0a8-4fc4-9ab4-6ac47c0dfa5f.png)

## kafka
\$ git clone https://github.com/wurstmeister/kafka-docker.git <br>
\$ code docker-compose-single-broker.yml =>vscode로 compose 수정 <br>
\$ docker-compose -f docker-compose-single-broker.yml up -d <br>
<img width="600" alt="kafka" src="https://user-images.githubusercontent.com/46228593/138092052-3714cae2-06d0-4ae2-8e52-2d1cc1bb177d.PNG"> <br>
<img width="600" alt="kafka2" src="https://user-images.githubusercontent.com/46228593/138092074-bbd966aa-21bf-436d-a9c0-e460be76af09.PNG">
